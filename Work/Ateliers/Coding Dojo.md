...
# 🧠 Idées et réflexions
> 🔗trello : https://trello.com/c/6Eeh3wd7/24-codingdojo-retours-trucs-astuces

> J'aimerais réussir à mettre en place des mini coding dojo et des workshops (Scrum, Kanban, XP, Lean...) entre midi et deux là où je suis, mais je voudrais savoir si tu avais de l'expérience là dessus, si tu en as déjà fait, les problèmes classiques, etc... Merci !  
>
> J'ai essentiellement fait des coding dojo en mob le midi.  
> Plusieurs problèmes :
> - on était trop nombreux, car tout le monde mangeait dans la salle
> - tout le monde n'était pas impliqué (edited)
>
> Après, on a aussi eu des gens qui ne voulaient pas en faire le midi, car ils ne trouvaient pas ça normal de faire ça sur leur temps de pause.  
> (du coup, ils en faisaient pas, ou étaient présent, mais pas impliquas, ce qui est pourri) (edited)
>
> Ensuite ; tout le monde n'a pas le même objectif en tête en arrivant au dojo.  
> C'est quelque chose à garder en tête  
> C'est encore mieux si tu arrives à le faire apparaître, et que les participant aient conscience de leur objectif
>
> Exemples d'objectifs:
> 
> - Découvrir le kata
> - Découvrir une techno
> -  Aller au bout du kata
> - Appliquer une contrainte rigolote (pas de souris, langage inconnu)
> - Evangéliser les autres participants
> - Monter que je suis le meilleur
>
> Parmi les Kata, un truc qui marchais bien, c'était le "[[Conference Tuesday]]". On passait une conférence sur grand écran dans une salle de réunion, et on débriefait après. (edited)
...
# ☑️ Checklist de Coding Dojo

> 🔗trello : https://trello.com/c/ucWChZEo/526-checklist-coding-dojo

Est-ce que vous êtes familiers des CodingDojo ?  
❤️ Expert  
👍 Confirmé  
😮 Débutant
...
Est-ce qu'il y a quelque chose que vous souhaitez travailler en particulier ?

- TDD > Test paramétrés > PBT
- Clean Code > SOLID > Calistenics
- Pair-Programming > Mob-Programming
- Focus > µCommit > TCR
- Apprendre son IDE > Sans Souris
- Défi algorithme
- Langage
...
# Compétences autour du Coding Dojo
```dataview
list
