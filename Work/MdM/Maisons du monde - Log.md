...
- [ ] Clarifier les états A evaluer // A essayer des pratiques
- [ ] Qui à les droits sur quoi ? Recenser les envs de prod et ce qui manque pour que les équipes soient autonomes en cas de changement

## [[2024-01-31]]

- [ ] Brancher New relis sur api-stock availability
...
Idées Perso
- Publier le catalogue des ateliers sur mon blog
...
- https://git.maisonsdumonde.net/core/dev/scm/carrier/referentiel-configuration/-/tree/master/prod?ref_type=heads
	...
	- [ ] Archiver le repository Gitlab `core/dev/scm/carrier/referentiel-configuration`
		- [ ] Décomissionner le vieux deployment de `core/dev/scm/carrier/api-services-catalog`
		- [ ] Décomissionner le vieux deployment de `core/dev/scm/carrier/api-carrier-repository`
...
- [ ] Mettre à plat les actions sur le parc applicatif, issue du Software Cockpit du parc applicatif SUPPLY
...
- Conversation avec Maxime
	- [ ] M'approprier la vision tech Supply, et le backlog ACOT
